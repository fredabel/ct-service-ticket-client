...
function Cart(){
    ...
    const handleCheckout = async () => {
        ...
        navigate('/checkout', { state: { items: selectedCartItems, tax: tax, shipping: shippingFee, discount_id: discount.id, discount_amount: discountAmount } });
    }
    ...
    return(
        <Container>
                        ...
                        <div>
                           {
                            ...
                            <div className="d-flex justify-content-between mb-2">
                                ...
                                <span className="fw-semibold text-danger">+ ${shippingFee.toFixed(2)}</span>
                            </div>

                            <div className="d-flex justify-content-between mb-2">
                                <span className="text-muted">Tax:</span>
                                <span className="fw-semibold text-danger">+ ${tax.toFixed(2)}</span>
                            </div>
                            <hr />
            ...
            :
             <Row>
                <Col> Your cart is empty <Button variant="primary" className="my-5" onClick={()=> navigate('/marketplace')}>Continue shopping</Button></Col>
